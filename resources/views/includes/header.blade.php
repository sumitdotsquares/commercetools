<div class="col-8"><a href="/"><img src="logo.svg" alt="icon" style="height: 70px; float: left; margin: 10px 20px 10px 10px;"></a></div>
<div class="col-4 align-text-bottom" style="text-align: right; font-size: 2em; margin-top: 30px;">
