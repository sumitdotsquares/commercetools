...
<div class="row">
   ...
   <div class="col-6">
      ...
      <div style="border: 1px solid silver; border-radius: 4px; padding: 20px 20px 10px; box-shadow: silver 0px 0px 6px 0px;">
         <div class="row mb-2">
            <div class="col"><label for="email">Email</label><input type="text" class="form-control" id="email" value=""></div>
            <div class="col"><label for="name">Password (N/A)</label><input type="password" class="form-control" id="password" value="aaaaa"></div>
         </div>
         <div class="row mb-2">
            <div class="col"><label for="name">Name</label><input type="text" class="form-control" id="name" value=""></div>
            <div class="col"><label for="address">Address</label><input type="text" class="form-control" id="address" value=""></div>
         </div>
         <div class="row mb-3">
            <div class="col"><label for="city">City</label><input type="text" class="form-control" id="city" value=""></div>
            <div class="col"><label for="country">country</label><select class="form-control" name="rcrs-country" id="country">
